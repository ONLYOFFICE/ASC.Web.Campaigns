...
const IndexPage = () => {
  const { t, i18n: { language } } = useTranslation("DocSpace");
          ...
          <div className="advent-announce-text">
            <div>
              <Trans i18nKey="Banner_DocSpace_TextDesktop">
                <b>ONLYOFFICE DocSpace released:</b> improve document collaboration with offices, customers, and partners. <b>Use it for free!</b>
              </Trans>
            </div>
          </div>
        </a>
