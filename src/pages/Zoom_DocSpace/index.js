...
const IndexPage = () => {
  const { t, i18n: { language } } = useTranslation("Zoom_DocSpace");
  ...
  return (
    <div className="zoom_docspace">
      <div className={"advent-announce advent-mobile-hide " + language}>
        <a target="_blank" href={LinkHref_Zoom_DocSpace} rel="noreferrer noopener">
          <div className="advent-announce-text">
            <div>
              <Trans i18nKey="Banner_Zoom_DocSpace_TextDesktop">
               <b>Collaborate on documents within Zoom meetings:</b> ONLYOFFICE DocSpace app for Zoom available
              </Trans>
            </div>
          </div>
        </a>
