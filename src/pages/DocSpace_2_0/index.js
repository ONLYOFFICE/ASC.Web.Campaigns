...
const IndexPage = () => {
  const { t, i18n: { language } } = useTranslation("DocSpace_2_0");
  ...
  return (
    <div className="docspace_2_0_released">
      <div className={"advent-announce advent-mobile-hide " + language}>
        <a target="_blank" href={LinkHrefDocSpace_2_0} rel="noreferrer noopener">
          <div className="advent-announce-text">
            <div>
              <Trans i18nKey="Banner_DocSpace_2_0_TextDesktop">
              Meet <b>ONLYOFFICE DocSpace 2.0</b> with Public rooms, plugins, data reassignment, and more
              </Trans>
            </div>
          </div>
        </a>
